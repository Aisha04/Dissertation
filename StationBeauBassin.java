...
public class StationBeauBassin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_beau_bassin);

        infos = new ArrayList<Infodb>();
        tClock = (TextClock) findViewById(R.id.textClock1);
        list = (ListView)findViewById(R.id.listBeaubassin);
                    ...
                    public void onDataChange( DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            if (info.getDate().equals(actualDate)) {
                                if (info.getStationName().equals("Beau Bassin")) {
                        ...
                        final list_beaubassin infoAdapter = new list_beaubassin(StationBeauBassin.this, infos, databaseReference, edtDate, edtTime, spinner, spinner1, spinner2, txttime, txtDes);
    ...
    public void onBackPressed() {
        Intent i= new Intent(StationBeauBassin.this,StationDisplay.class);
        startActivity(i);
        finish();
    }
