...
public class list_stlouis extends ArrayAdapter<Infodb> {
    private Activity context;
    private List<Infodb> infos;
    DatabaseReference databaseReference;
    TextView edtName, edtDate, txttime, txtDes;
    Spinner spinner, spinner1, spinner2;
    public list_stlouis(Activity context, List<Infodb> infos, DatabaseReference databaseReference, TextView edtName, TextView edtDate, Spinner spinner, Spinner spinner1, Spinner spinner2, TextView txttime, TextView txtDes) {
        super(context, R.layout.layout_stlouis, infos);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.layout_stlouis, null, true);
