...
public class Phoenix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Phoenix.this, android.R.layout.simple_spinner_item, question);
        ...
        btnsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(infoId)){
                    ...
                    Toast.makeText(Phoenix.this, "Successfully created", Toast.LENGTH_SHORT).show();
    ...
    public void retrieve1() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Phoenix.this, android.R.layout.simple_spinner_item, Phoenix);
        arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
       ...
       // Query query = databaseReference.orderByChild("trainNumber").startAt("0017").endAt("0018");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Phoenix.this, android.R.layout.simple_spinner_item, nameList);
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
