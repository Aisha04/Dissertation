...
public class StationPheonix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_pheonix);

        infos = new ArrayList<Infodb>();
        tClock = (TextClock) findViewById(R.id.textClock1);
        list = (ListView)findViewById(R.id.listPheonix);
                    ...
                    public void onDataChange( DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            if (info.getDate().equals(actualDate)) {
                                if (info.getStationName().equals("Phoenix")) {
                        ...
                        final list_phoenix infoAdapter = new list_phoenix(StationPheonix.this, infos, databaseReference, edtDate, edtTime, spinner, spinner1, spinner2, txttime, txtDes);
    ...
    public void onBackPressed() {
        Intent i= new Intent(StationPheonix.this,StationDisplay.class);
        startActivity(i);
        finish();
    }
