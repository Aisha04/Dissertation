    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(v.getContext(), AdminEdit.class);
        ...
        btnCPW.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), AdminPW.class));
            }
        });
                    ...
                    user.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(AdminProfile.this, "Your profile is deleted:( Create a account now!", Toast.LENGTH_SHORT).show();
                                databaseReference.child(user.getUid()).removeValue();
                                startActivity(new Intent(getApplicationContext(),Login_Form.class));
                            } else {
                                Toast.makeText(AdminProfile.this, "Failed to delete your account!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
