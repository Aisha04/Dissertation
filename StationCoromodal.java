...
public class StationCoromodal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_coromodal);

        infos = new ArrayList<Infodb>();
        tClock = (TextClock) findViewById(R.id.textClock1);
        list = (ListView)findViewById(R.id.listCoromodal);
                    ...
                    public void onDataChange( DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            if (info.getDate().equals(actualDate)) {
                                if (info.getStationName().equals("Coromandel")) {
                        ...
                        final list_coromondal infoAdapter = new list_coromondal(StationCoromodal.this, infos, databaseReference, edtDate, edtTime, spinner, spinner1, spinner2, txttime, txtDes);
    ...
    public void onBackPressed() {
        Intent i= new Intent(StationCoromodal.this,StationDisplay.class);
        startActivity(i);
        finish();
    }
