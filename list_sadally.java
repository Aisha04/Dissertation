...
public class list_sadally extends ArrayAdapter<Infodb> {
    ...
    public list_sadally(Activity context, List<Infodb> infos, DatabaseReference databaseReference, TextView edtName, TextView edtDate, Spinner spinner, Spinner spinner1, Spinner spinner2, TextView txttime, TextView txtDes) {
        super(context, R.layout.layout_sadally, infos);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.layout_sadally, null, true);
