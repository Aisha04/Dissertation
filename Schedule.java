...
public class Schedule extends AppCompatActivity implements TimerPickerFragment.TimePickerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTime = (TextView) findViewById(R.id.txtlate2);
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String trainNumber = spinner2.getSelectedItem().toString();
                String date = edtDate.getText().toString();
                String arrivalTime = edtTime.getText().toString();
                String  stationName= spinner10.getSelectedItem().toString();
                String platformNumber = spinner1.getSelectedItem().toString();
                ...
                if (TextUtils.isEmpty(infoId)){
                    ...
                    Toast.makeText(Schedule.this, "Successfully created", Toast.LENGTH_SHORT).show();
    ...
    public void station(){
        ...
        query1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, nameList);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 0) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, BeauBassin);
                            spinner1.setAdapter(arrayAdapter);
                        ...
                        if (position == 1) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, Coromandel);
                            spinner1.setAdapter(arrayAdapter);
                        ...
                        if (position == 2) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, Curepipe);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 3) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, Floreal);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 4) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, Phoenix);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 5) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, PortLouis);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 6) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, QuatreBornes);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 7) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, RoseHill);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 8) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, Sadally);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 9) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, StJean);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 10) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, StLouis);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 11) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, Trianon);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 12) {
                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Schedule.this, android.R.layout.simple_spinner_item, Vacoas);
                            spinner1.setAdapter(arrayAdapter);
                            spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
