...
public class PortLouis3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_port_louis3);


       // dbtrain = (TextView)findViewById(R.id.dbtrain);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PortLouis3.this, android.R.layout.simple_spinner_item, reason);
        ...
        ArrayAdapter<String> arrayAdapter2 = new ArrayAdapter<String>(PortLouis3.this, android.R.layout.simple_spinner_item, late);
        ...
        btnsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(infoId)){
                    ...
                    Toast.makeText(PortLouis3.this, "Successfully created", Toast.LENGTH_SHORT).show();
    ...
    public void retrieve1() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PortLouis3.this, android.R.layout.simple_spinner_item, PortLouis);
        arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void T1(){
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PortLouis3.this, android.R.layout.simple_spinner_item, nameList);
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
