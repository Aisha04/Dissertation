...
public class StationSadally extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_sadally);

        infos = new ArrayList<Infodb>();
        tClock = (TextClock) findViewById(R.id.textClock1);
        list = (ListView)findViewById(R.id.listSadally);
                    ...
                    public void onDataChange( DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            if (info.getDate().equals(actualDate)) {
                                if (info.getStationName().equals("Sadally")) {
                        ...
                        final list_sadally infoAdapter = new list_sadally(StationSadally.this, infos, databaseReference, edtDate, edtTime, spinner, spinner1, spinner2, txttime, txtDes);
    ...
    public void onBackPressed() {
        Intent i= new Intent(StationSadally.this,StationDisplay.class);
        startActivity(i);
        finish();
    }
