...
public class RoseHill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rose_hill);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(RoseHill.this, android.R.layout.simple_spinner_item, question);
        ...
        btnsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(infoId)){
                    ...
                    Toast.makeText(RoseHill.this, "Successfully created", Toast.LENGTH_SHORT).show();
    ...
    public void retrieve1() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(RoseHill.this, android.R.layout.simple_spinner_item, RoseHill);
        arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
       ...
       // Query query = databaseReference.orderByChild("trainNumber").startAt("0029").endAt("0030");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(RoseHill.this, android.R.layout.simple_spinner_item, nameList);
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
