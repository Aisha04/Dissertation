...
public class portlouis2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portlouis2);
       ...
       txtstation = (TextView)findViewById(R.id.txtstation);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(portlouis2.this, android.R.layout.simple_spinner_item, question);
        ...
        btnsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(infoId)){
                    ...
                    Toast.makeText(portlouis2.this, "Successfully created", Toast.LENGTH_SHORT).show();
    ...
    public void retrieve1() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(portlouis2.this, android.R.layout.simple_spinner_item, PortLouis);
        arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void T11(){
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(portlouis2.this, android.R.layout.simple_spinner_item, nameList);
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
