...
public class StationCurepipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_curepipe);

        infos = new ArrayList<Infodb>();
        tClock = (TextClock) findViewById(R.id.textClock1);
        list = (ListView)findViewById(R.id.listCurepipe);
                    ...
                    public void onDataChange( DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            if (info.getDate().equals(actualDate)) {
                                if (info.getStationName().equals("Curepipe")) {
                        ...
                        final list_curepipe infoAdapter = new list_curepipe(StationCurepipe.this, infos, databaseReference, edtDate, edtTime, spinner, spinner1, spinner2, txttime, txtDes);
    ...
    public void onBackPressed() {
        Intent i= new Intent(StationCurepipe.this,StationDisplay.class);
        startActivity(i);
        finish();
    }
